"""
知识蒸馏训练入口
用法: python scripts/train_distill.py --student eca --teacher weights/teacher_best.pt --epochs 100
"""
import os
import sys
import json
...
def train_distill(args):
    ...
    exp_name = f"{timestamp}_distill_{args.student}"
    ...
    # 如果是自定义配置，加载预训练权重
    if not student_cfg.endswith(".pt"):
